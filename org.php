...
if (isset($_POST["submit"])){
  ...
  $query="INSERT INTO organisation (org_name) VALUES
  (' $organisation' )";
...
if(isset($_GET['page']))
    ...
    $next_page=$page+1;
    $sql="select * from organisation order by org_id desc limit $start_from,$num_per_page" ;
     $result=mysqli_query($con,$sql);
...
<body>
    <div>
<div class="menu_bar">
   <h1 class="logo">            ORGANIZATION<span>  NAME</span></h1>
   <ul>
    <li><a href="login3.php">Home </a></li>
  ...
  <div class="col-sm-3">
  <label for="formGroupExampleInput"><h5>Create Organization Name  :</h5></label>
  </div>
  <div class="col-sm-7">
  <input type="text " name="organisation" class="form-control" id="formGroupExampleInput" placeholder="Enter Organization Name">
  </div>
  <div class="col-sm-2">
  ...
  Create
    ...
    <div class="container">
<?php
$pr_sql="select * from organisation  ";
...
{
  $pr_sql="select * from organisation order by org_id desc limit 10";
?>
    <tr>
